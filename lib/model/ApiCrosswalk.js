class ApiCrosswalk  {
  constructor(obj) {
    ...
    this.summary = obj.forecast.txt_forecast.forecastday[0].fcttext;
    this.high = obj.forecast.simpleforecast.forecastday[0].high.fahrenheit;
    this.low = obj.forecast.simpleforecast.forecastday[0].low.fahrenheit;
